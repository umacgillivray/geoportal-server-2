...
G.evaluators.iso = {
  ...
  evalOther: function(task) {
    ...
    /* band */
    G.evalProps(task,item,root,"mdband_name_s","//gmd:MD_Band/gmd:sequenceIdentifier/gco:MemberName/gco:aName/gco:CharacterString");
    G.evalProps(task,item,root,"mdband_attrtype_s","//gmd:MD_Band/gmd:sequenceIdentifier/gco:MemberName/gco:attributeType/gco:TypeName/gco:aName/gco:CharacterString");
    G.evalProps(task,item,root,"mdband_desc_s","//gmd:MD_Band/gmd:descriptor/gco:CharacterString");
    G.evalProps(task,item,root,"mdband_units_s","//gmd:MD_Band/gmd:units/@xlink:href");

    /* grid */
    G.evalProps(task,item,root,"grid_dimensions_num_i","//gmd:MD_GridSpatialRepresentation/gmd:numberOfDimensions/gco:Integer");
    G.evalProps(task,item,root,"grid_dimension_name_s","//gmd:MD_GridSpatialRepresentation/gmd:axisDimensionProperties/gmd:MD_Dimension/gco:Integer/gmd:dimensionName/gmd:MD_DimensionNameTypeCode");
    G.evalProps(task,item,root,"grid_dimension_size_i","//gmd:MD_GridSpatialRepresentation/gmd:axisDimensionProperties/gmd:MD_Dimension/gco:Integer/gmd:dimensionSize/gco:Integer");
    G.evalProps(task,item,root,"grid_cell_geometry_s","//gmd:MD_GridSpatialRepresentation/gmd:cellGeometry/gmd:MD_CellGeometryCode/@codeListValue");    
  },
  ...
  evalService: function(task) {
    ...
    G.evalResourceLinks(task,item,root,"resources","gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource/gmd:linkage/gmd:URL | gmd:identificationInfo/srv:SV_ServiceIdentification/srv:containsOperations/srv:SV_OperationMetadata/srv:connectPoint/gmd:CI_OnlineResource/gmd:linkage/gmd:URL");

    /*
    G.forEachNode(task,root,"//gmd:identificationInfo/srv:SV_ServiceIdentification",function(node){
      var serviceType = G.getString(task,node2,"serviceType/gco:LocalName");
      G.forEachNode(task,node,"srv:containsOperations/srv:SV_OperationMetadata/srv:connectPoint/gmd:CI_OnlineResource/gmd:linkage/gmd:URL",function(node2){
        // THREDDS // JSON
      });
    });
     */
